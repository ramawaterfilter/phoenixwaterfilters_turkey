        ...
        r = function() {
            ...
            return s.prototype = Object.assign({}, s.prototype, {
                ...
                renderSearchResults: function(t) {
                    ...
                    this.title && (this.title.innerHTML = i.querySelector("[data-title-search]").innerHTML), this.results && (this.results.innerHTML = i.querySelector("[data-results-search]").innerHTML), this.listSuggest && (this.listSuggest.innerHTML = i.querySelector("[data-listsuggest-search]").innerHTML);
                    try {
        ...
        function e() {
            ...
            r > 0 && r >= Date.now() ? T4SThemeSP.Helpers.promiseStylesheet(T4Sconfigs.stylesheet4).then(function() {
                ...
                "NVT_94" != s && T4SThemeSP.Helpers.promiseStylesheet(T4Sconfigs.stylesheet4).then(function() {
                    h.html(t(s).html()), e(), "function" == typeof T4SThemeSP.reinitProductGridItem && T4SThemeSP.reinitProductGridItem(), isStorageSpSession && (r = Date.now() + 24e6, sessionStorage.setItem(i, r), sessionStorage.setItem(n, t(s).html()))
                })
            })
        }()
    }
